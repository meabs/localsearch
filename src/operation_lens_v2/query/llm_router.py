...
OPENROUTER_CITATION_LIMIT = settings.openrouter_citation_limit
LOCAL_FINDINGS_LIMIT = settings.local_findings_limit
OPENROUTER_FINDINGS_LIMIT = settings.openrouter_findings_limit
EXACT_FINDINGS_LIMIT = settings.exact_findings_limit
RELATIONSHIP_FINDINGS_LIMIT = settings.relationship_findings_limit
CHUNK_FINDINGS_LIMIT = settings.chunk_findings_limit
